...
1. Создайте **Internal Integration** в Sentry и возьмите из неё токен (он привязан к организации, а не к личной учётке). В UI: **Organization Settings → Developer Settings → Internal Integrations → Create Internal Integration**; в **Permissions** включите чтение организации и проектов (например `org:read`, `project:read` — по необходимости экспортёра). После сохранения скопируйте **Token**. См. [Internal Integration](https://docs.sentry.io/product/integrations/integration-platform/internal-integration/) и [документацию API](https://docs.sentry.io/api/auth/).
